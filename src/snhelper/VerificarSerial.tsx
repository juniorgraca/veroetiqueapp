    ...
    if (itemMessage.startsWith('Item informado inválido')) {
      ...
      setMessage(
        <div>
          ...
          <span style={{ fontWeight: 'bold', color: '#130101'}}>EQUIPAMENTO: {itemCod} {itemMessage}</span><br />
          <span style={{ fontWeight: 'bold', color: '#fff' }}>SERIAL NUMBER: {itemInput} </span><br/>
          <img src={itemImg}  width="450px"alt="" />
        </div>
      );
