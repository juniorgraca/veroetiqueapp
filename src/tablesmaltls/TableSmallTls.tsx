      ...
      <div>
        ...
        {Array.from({ length: Math.max(dadosColuna1.length, dadosColuna2.length) }).map((_, rowIndex) => (
          <section key={rowIndex}>
            <div className="sect2SmallTls">
              <div className="textareaSmalTls">
                <div className="pretextSmalTls">
                  <p className="textpsmalltls">
                    CÓD.: {dadosColuna1[rowIndex]?.codigo || ''}
                  </p>
                </div>
                <div className="pretextSmalTls">
                  <p className="texdescrSmallTls">
