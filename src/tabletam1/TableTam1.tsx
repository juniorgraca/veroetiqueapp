    ...
    <>
      <div>
        ...
        {Array.from({ length: Math.max(dadosColuna1.length, dadosColuna2.length) }).map((_, rowIndex) => (
          <section className="secName" key={rowIndex}>
            <div className="sect2Tab1">
              <div className="textareaTab1">
                <div className="pretextTab1">
            
                  <p className="textpTab1">
